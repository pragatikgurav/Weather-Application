    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-sky-950 via-sky-900 to-indigo-950 px-4">
      <Card className="w-full max-w-md bg-sky-900/50 backdrop-blur-lg border-sky-700/40 shadow-2xl">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-sky-50">Welcome Back</CardTitle>
          <CardDescription className="text-sky-300">Sign in to check the weather</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-center text-sm text-sky-300">
              ...
              <Link to="/signup" className="text-sky-400 hover:text-sky-200 underline underline-offset-4">
                Sign up
              </Link>
            </p>
          </form>
